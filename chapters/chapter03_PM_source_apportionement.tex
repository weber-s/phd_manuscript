...
de l'ouest, les polyols ne représentent qu'entre \SIrange{0.1}{2.1}{\percent}. La même
contribution relative est trouvée pour le glucose.
...
plus de \SI{40}{\percent} de la matière organique en été à certains sites (voir
...
mais représente seulement 0.1 à \SI{2.1}{\percent} de la matière organique.
...
mais peut représenter jusqu'à \SI{40}{\percent} de la matière organique en période chaude sur certains
...
Aussi, une part importante de l'OC est amené par ce facteur (environ \SI{10}{\percent} de l'OC
total), mais également du sulfate (environ \SI{15}{\percent}), suggérant la présence de composés
organiques suflatés.
Ainsi, en moyenne estivale, c'est entre \SI{20}{\percent} et \SI{40}{\percent} de la matière organique qui est
...
figure~\ref{fig:chapter03/borlaza/LF-PBOA}). Notamment, près de \SI{60}{\percent} de la cellulose est
...
comme suspecté auparavant, ce facteur est également responsable d'environ \SI{20}{\percent} de l'acide
...
et un ``seuil'' aux alentours de \SI{15}{\percent} d'incertitude fait basculer la solution entre 11 et
...
Notamment, grâce a des mesures sous tunnel et a un jeu d'espèces organiques plus détaillé,
nous espérons pouvoir séparer différents types d'émissions véhiculaires dans cet
environnement particulier de très haute altitude ou les processus de combustion sont

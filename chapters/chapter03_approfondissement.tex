...
\begin{table}[ht]
    ...
    \begin{tabular}{r P{2cm} P{1.5cm} P{5.0cm} P{3.0cm}}
        ...
        \midrule
        PMF         & OC, EC                  & As, Pb, Ti, V & MSA, \NOt, \SOq, Oxalate, \ce{\ce{K+}}, \ce{\ce{Na+}}, \ce{\ce{Cl-}}, \ce{Ca^2+}, \ce{Mg^2+}, \NHq   & Lévoglucosan, $\sum$polyols, HAP \\
        \midrule
...
\label{ssub:résumé_du_chapitre_3}
...
progressive des émissions liés au trafic routier, également retouvé par la tendance à

...
La figure~\ref{fig:pairplotOPs} illustre cette association entre \POAAv{} et \PODTTv{}
pour l'OC, EC, Lévoglucosan, \NOt, Cu et Fe sur un ensemble de 16 sites de prélèvements en
France pour un total de plus de 3400 échantillons, retrouvant bien les résultats
précédement obtenus dans la littérature.

...
probablement un impact sanitaire plus délétaire alors que la métrique de la masse seule
...
\begin{enumerate}
    ...
    \item pas besoin d'identifier chaque espèce chimiques du moment que les sources
...
chimiques~\autocite{charrierRates2015,charrierBias2016,calasImportance2017}.  Aussi, aucun
...
présence de sulfate.  La prise en compte de ces non-linéarité et des actions conjointes

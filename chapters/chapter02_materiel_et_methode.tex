...
ultra-son pendant \SI{40}{\minute} dans une solution aqueuse de \SI{3}{\mili\L} tamponé à pH
4.8 par un buffer au thymol. Deux solutions enzymatiques (cellulase (Sigma Aldrich, C2730)
avec \SI{20}{\micro\L} de solution aqueuse à \SI{70}{unit.\g^{-1}} et glucosidase (Sigma
...
\SI{1}{\mili\L\per\minute} et le volume d'injection de \SI{250}{\micro\L}.
À chaque lot d'analyse est également inclus une solution standard de glucose et de
cellulose (perles de \SI{20}{\micro\m}, Sigma Aldrich, S3504) analysées selon le même

...
est proposée en annexe~\ref{annexe:programmes}.
...
Le principe de mesure est basé sur la détection par détecteur FID du \ce{CH4} issue de la
...
Il existe différents types de fluides mimiquant les surfactants pulmonaires
...
Une telles non-linéarité n'est pas observée pour les tests à l'acide ascorbique.
...
cristallin, et présenter des substitutions avec du sulfate ou du nitrate. De même que le
...
implicite du jeu de donnée et tant que la quantité d'analyses était restreinte.

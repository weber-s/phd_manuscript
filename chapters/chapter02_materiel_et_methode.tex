...
particulièrement celles effectuées sur le plateau analytique Air-O-Sol.
...
non redox-active (par ex. le lévoglucosan) et des espèces co-émises mais non mesurée (par ex. les
quinones). Quand bien même toutes les espèces seraient mesurées, on se retrouverait alors
avec un système d'équation avec beaucoup trop d'inconnues par rapport au nombre
...
Les prélèvements sont réalisés sur des filtres en fibre de quartz
pré-chauffés à \SI{500}{\degreeCelsius} pendant 8 heures pour se prévenir de la présence en espèces
...
lung fluid} (SLF)). Les analyses de cette thèse ont toutes été réalisées selon le du protocole de
\textcite{calasPollution2017}, pour lequel il est fait usage d'un mélange de solution de Gamble+DPPC.
\textcite{calasImportance2017} ont pu montrer que différents SLF produisent des mesures de PO
sensiblement différentes. Notamment, l'ALF tend à produire des mesures de PO
systèmatiquement inférieures à la mesure faite dans du Gamble+DPPC (2 à 3 fois plus
faible), qui elle-même est légèrement inférieure à la mesure faite dans de l'eau milli-Q.
...
Le suivit cinétique se fait par titration à intervals réguliers (0, 15 et 30 minutes) du DTT
...
de COV anthropiques.  
L'oxalate est également un composé issu de réaction photochimique,
...
quelques travaux sont en cours dans le groupe en ce sens et présentés dans le
chapitre~\ref{cha:approfondissement_des_connaissances_des_sources_des_pm}.

Il faut noter que d'autres techniques d'analyses, notamment via des mesures de en
...
sulfate d'ammonium \ce{SO4(NH4)2}. Cependant, une part de cet aérosol inorganique tracé
...
cristallin, et présentée des substitutions avec du sulfate ou du nitrate. De même que le
...
Cependant, l'accumulation de mesure provenant de différents programmes de recherche et la
...
homogènes (même unité, même nomenclature, même format de date…) et intercomparable
...
La quantité de données créer aussi un besoin de visualisation rapide de ces mesures et
...
très nombreuses mesures, une des premières étapes a consisté en la mise en place d'une
base de données centralisée et homogène de la filtrothèque, pouvant ainsi être traité de
manière automatisée.
\end{tcolorbox}
...
\todo{Mettre un ou deux graph et exemple d'utilisation}

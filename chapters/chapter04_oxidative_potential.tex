...
%et ici, est-ce qu'il ne faudrait pas être plus inclusif "importance du trafic routier pour l'expo chronique annuelle et le chauffage résidentiel pour l'exposition saisonnière hivernale? à toi de dire 
%Ce résultat, intuitif car il est connu empiriquement depuis longtemps qu'il vaut mieux ne
%pas respirer derrière un pot d'échappement, est néanmoins encourageant, car de nombreuses
%villes et métropoles, mais aussi individus, se dirigent d'ors et déjà vers une diminution
%de l'utilisation de la voiture individuelle. bof, mal écrit, le lien entre l'empirisme de ne pas respirer un pot d'échappement et les diminutions dans les villes, ou la la....
%Il est donc espérable d'avoir dans les années
%futures à la fois une lutte efficace contre le dérèglement climatique et une amélioration
%de la qualité de l'air.  =>dernière phrase mal écrite..trop de généralités et .c'est pas toutes les voitures qui émettent bcp de co2 (et pis en plus c'est pas les mêmes qui émettent les particules!....et pis maintenant y a les filtres à particules...)
%Yep, cette partie est en mode "Le monde il va mieux aller licorne rose et tout". Mais je supprime.
%oui car on va tous crever, on va tous crever, la fin du monde approche et nous on fait la fete . signé les VRP.
...
solubilisation des particules \todo{(ref Weber)} et donc présente un PO différent du fait uniquement de la

...
\todo{il faut penser à faire un mail à Imad/André pour mettre ce graphique dans ta thèse. Pour cochabama c'est bon, pour Strasbourg il faut demander à Jluc à qui il faut demander}
...
%Gaëlle : Tu en étais ici. J'ai accepté les modifications avant
...
Seulement, nous avons vu que les PMF sont très sensibles aux variables utilisées. Or, leurs
études PMF incluent un ensemble d'espèces chimiques restreint (une dizaine de métaux et le
WSOC), en plus du PO. Seuls 4 facteurs sont identifiés par~\cite{fangOxidative2016}, ce
qui semble peu au regard des PMF utilisant un jeu d'espèce chimique plus conséquent (voir
notamment tout le chapitre précédent). En plus, ce faible nombre d'espèces chimiques
...
comparée aux autres sites d'étude.
...
corrélations semblent dépendre du site considéré, bien qu'une corrélation positive semble
...
Les Frènes, opéré par Atmo Auvergne Rhônes-alpes, des prélèvements journaliers depuis 2013
...
On remarque tout d'abord la grande cyclicité saisonnière des 2 PO et son absence --ou
...
Les différentes tailles des particules ne pénétrant pas de façons identique dans le système
...
Sur 6 sites opérés par l'EMPA en Suisse, les prélèvements conjoints de la fraction grossière
...
Afin de poursuivre cette investigation, une étude comparative sur 6 sites de l'EMPA est
en court par Stuart Grange et à laquelle je prends part, sur les fractions \PMdix{} et
...
Comme expliquée précédemment, la connaissance des ROS émis ou induit par les PM de
chacune des sources d'émissions majeure permettrait la mise en place de mesure de
...
mesurées aux PO, ou nécessiterait des conditions très opportunistes (formation de nitrate

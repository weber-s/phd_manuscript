...
protection de la qualité de l'air plus efficaces qu'une régulation fondée uniquement sur la
masse des particules.
Cette mesure des ROS peut être estimée en premier ordre par la mesure du PO des PM pour
des sources individualisées.
Seulement, certaines catégories de PM ne pourront tout simplement pas être directement
mesurées pour leurs PO, ou nécessiteraient des conditions très opportunistes (formation de
nitrate d'ammonium secondaire, fort épisode de vent saharien, émission biogénique
primaire, etc.) pour obtenir des prélèvements adéquats.
...
chimiques ont été analysées, le \POv{} a également été mesuré pour les tests AA et DTT. Ainsi, suivant
la procédure décrite en figure~\ref{fig:workflow_inversion}, il est possible d'estimer les
source de PM au site récepteur et de leur attribuer un PO intrinsèque (i.e. par
...
Cette section démontre tout d'abord qu'il est possible de déterminer les sources de PO grâce à
...
pulmonaire et ses incertitudes, avec de très bonnes performances statistiques.
...
des sources par rapport à une ``vision massiques''. En accord avec les résultats des 3 études précédentes faites aux États-Unis
...
expliquant diffèrent --bien que la même tendance générale soit observée. En l'absence
...
\POAAv{} mais présente en réalité un PO intrinsèque quasi-nul. Inversement, le facteur
...
masse \PMdix, mais des sources de potentiels oxydants de particules.
...
\todo{je pense qu'il faut dire que ce travail a été  fait sans introduire les traceurs qui conduisent a un facteur AOS anthropiques, et donc que les résultats pourraient en partie etre modifiés par ca.

Le papier PO grenoble 3 site remet ca en cause ? Il faut l'introduire ici (ainsi que les
travaux du papier Nature}

\section{Conclusion du chapitre}%
\label{sec:conclusion_chap4}

\subsection{Une nouvelle vision de l'aérosol, plus proche de l'exposition sanitaire}%

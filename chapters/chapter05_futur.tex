...
Formellement, un réseaux de neurones est un graph orienté pondéré, où lorsque deux
...
Au sein de chaque nœud, l'information recu est condensé en une valeure unique puis propagée à
...
Appliqué sur les 3 sites de la métropole Grenobloise, les performances statistiques des
deux types de modèles (MLP et regression linéaire MLR) sont relativement similaires
(figure~\ref{fig:perfMLPMLR}) et chacuns des deux modèles prédit relativement bien chaque
\POv{} sur les 3 sites.
...
\begin{figure}[ht]
    ...
    sites de Grenoble \autocite{borlazaUrbaninprep}. }%

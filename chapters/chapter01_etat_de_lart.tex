...
facteurs explicatifs les plus importants pour la compréhension des concentrations en
vallées alpines.
...
L'air que nous respirons est donc constitué majoritairement de gaz (\ce{N2}, \ce{O2}…) mais
...
constituent une famille de composés appellés
communément particules fines, \textit{particulate matter} (PM).
...
très diverses, comme le montre la Figure~\ref{fig:aerosolDistribution}, et selon
...
\SOq, formé par condensation et réaction chimique du \ce{SO2} mais également émis par les volcans et les
...
important d'espèces chimiques comportant une chaine carbonée, de l'oxygène et
...
d'autres familles de molécule comme les alcanes, hopanes, composés aromatiques
polycycliques
ou pesticides. Cette matière carbonée est souvent nommée matière
